      ...
      sections: {
        ...
        channels: {
          ...
          voice: {
            ...
            detail: 'Aircall como Cloud PBX + Twilio como bridge telefónico + ElevenLabs como agente de voz conversacional. Jacobo era literalmente un "compañero más" en la centralita Aircall con sus propias reglas de routing.',
            highlights: [
        ...
        platformEvolution: {
          ...
          steps: [
            ...
            },
            {
              ...
              detail: 'Jacobo activo 24/7 durante meses. Formó parte de la venta del negocio como activo operativo. El comprador lo adquirió funcionando. Cinco años de arquitectura limpia lo hicieron inevitable.',
            },
          ],
...
Presupuesto reparándolo todo junto: \${totalConDescuento.toFixed(2)} €\`;`,
      ...
      cta: {
        ...
        body: 'Jacobo gestionaba citas, consultaba inventario real y escalaba con contexto, todo en menos de 30 segundos. La arquitectura de sub-agentes, tool calling y patrones HITL se aplica directamente a travel, fintech, salud o e-commerce.',
        label: 'LinkedIn',
      ...
      downloads: {
        ...
        inlineLabel: 'Descargar workflow',
        inlineHint: 'Importa en n8n en 1 click',
        section: {
          heading: 'Pruébalo Tú Mismo',
          intro: 'Estos son los workflows reales que corrieron en producción durante 2 años. Sanitizados, documentados, listos para importar en n8n. Si construyes algo con ellos, me encantaría verlo.',
        ...
        workflows: [
          ...
          },
          {
            ...
            href: '/jacobo/workflows/calculadora-santifer.json',
            fileSize: '~2.7 KB',
            nodes: '3 nodos',
          },
          {
    ...
    en: {
      ...
      sections: {
        ...
        channels: {
          ...
          voice: {
            name: 'Landline (voice)',
            detail: 'Aircall as Cloud PBX + Twilio as phone bridge + ElevenLabs as conversational voice agent. Jacobo sat on the Aircall phone system as a literal "teammate" with its own routing rules.',
            highlights: [
...
Presupuesto reparándolo todo junto: \${totalConDescuento.toFixed(2)} €\`;`,
      ...
      cta: {
        ...
        body: 'Jacobo handled appointments, queried real inventory, and escalated with context, all in under 30 seconds. The sub-agent architecture, tool calling, and HITL patterns apply directly to travel, fintech, healthcare, or e-commerce.',
        label: 'LinkedIn',
        labelSecondary: 'Email',
      },
      faq: {
      ...
      downloads: {
        ...
        inlineLabel: 'Download workflow',
        inlineHint: 'Import into n8n in 1 click',
        section: {
          heading: 'Run It Yourself',
          intro: 'These are the actual workflows that ran in production for 2 years. Sanitized, documented, ready to import into n8n. If you build something with them, I\'d love to see it.',
